...
class UNet2DConditionModel(
    ...
    def forward(
        ...
        if is_controlnet:
            ...
            for i, add_res in enumerate(down_block_additional_residuals):
                down_block_res_samples[i] = down_block_res_samples[i] + add_res
        ...
        if is_controlnet:
            ...
            # print(mid_block_additional_residual)
